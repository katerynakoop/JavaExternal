...
public class SonnetController
{
    ...
    public void execute()
    {
        ...
        for (String url: urls)
        {
            Map<String, Integer> smallMap = model.getSmallMap(url);
            model.addSmallMapToListOfSmallMaps(smallMap);
        }
        model.addDataToBigMap();
        ...
        //view.displayMapOfWordsAndTheirFreq(model);
    }
}
